...
/**
 * getHead
 * Helper method to find the head of the linked list of the bucket in the given index.
 */
void *getHead(HashTable *hashTable, unsigned int index);

/**
 * Helper method that returns the number of buckets in the hash table.
 */
unsigned int returnNumBuckets(HashTable *hashTable);

/**
 * Helper method allows you to find the value of a certain element within
 * a linked list with the passed in bucket index and index of the element in the linked list.
 */
